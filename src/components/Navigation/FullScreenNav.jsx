...
const FullScreenNav = () => {
  ...
  return (
    <div
      ref={fullScreenRef}
      id="fullScreenNav"
      className="fullscreennav hidden text-white h-screen overflow-hidden w-full absolute bg-black z-50"
    >
      ...
      <div ref={fullNavLinksRef} className="relative">
        <div className=" navlink flex w-full justify-between p-2 items-start">
          ...
          <div className="h-30 w-30 relative cursor-pointer">
            {/* First diagonal */}
            {/* <div className="h-30 w-0.5 absolute right-13 bg-white rotate-45 origin-center"></div> */}
            {/* Second diagonal */}
            {/* <div className="h-30 w-0.5 right-13 absolute bg-white -rotate-45 origin-center"></div> */}
          </div>
        ...
        <div className="py-20 ">
          <div className="link  origin-top  relative border-t-1 border-white overflow-hidden">
            <h1 className="font-[font2] uppercase text-[8vw] text-center leading-[0.8] pt-2 tracking-tighter font-bold ">
              Projects
            </h1>
            <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
              <div className="moveX flex items-center">
                <h2 className="whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl  text-center lg:leading-[0.8] lg:pt-5  uppercase">
                  Pour Tout voir
                </h2>
                <img
